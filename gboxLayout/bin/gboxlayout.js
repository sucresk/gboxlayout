    ...
    var GBox = /** @class */ (function (_super) {
        ...
        function GBox() {
            ...
            _this.onLabelClick = function (e) {
                var selectId = parseInt(e.target['id']);
                if (isNaN(selectId)) {
                    return;
                }
        ...
        GBox.prototype.getData = function () {
            ...
            if (isNaN(this._minWidth) || this._minWidth == gboxLayout.GBoxLayout.MIN_SIZE) {
                delete data.minWidth;
            }
            if (isNaN(this._minHeight) || this._minHeight == gboxLayout.GBoxLayout.MIN_SIZE) {
        ...
        GBox.prototype.removePanel = function (panel) {
            ...
            var panelIndex = this.panels.indexOf(panelname);
            if (panelIndex >= 0) {
        ...
        GBox.prototype.parsePanels = function () {
            ...
            if (this._panels && this.owner) {
                for (var i = 0, len = this._panels.length; i < len; i++) {
                    ...
                    var panel = this.owner.getPanel(panelID);
                    panel.parent = this;
...
(function (gboxLayout) {
    var GBoxLayout = /** @class */ (function (_super) {
        ...
        GBoxLayout.prototype.getPanel = function (id) {
            var panelInstance = this._panelDic[id];
            if (panelInstance) {
                ...
                return new gboxLayout.GPanel(id);
            }
        };
